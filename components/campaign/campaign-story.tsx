...
export function CampaignStory({ story, creatorBio, creatorName }: CampaignStoryProps) {
  return (
    <div className="space-y-10">
      <section>
        <h2 className="text-base font-semibold text-white">Story</h2>
      ...
      <section>
        <h2 className="text-base font-semibold text-white">About the creator</h2>
        <div className="mt-4 flex gap-4">
          ...
          <div>
            <p className="text-sm font-medium text-zinc-100">{creatorName}</p>
            <p className="mt-1 text-sm text-zinc-400 leading-relaxed">{creatorBio}</p>
          </div>
        </div>
      </section>
    </div>
